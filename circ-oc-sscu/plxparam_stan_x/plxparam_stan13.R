...
# - - - - -  - - - - -  - - - - -  - - - - -  - - - - -  - - - - -  - - - - - 
file_path <- "/beegfs/car/bxster25/circ-oc-sscu/gaia18_subset/subset_13.csv" 
df <- fread(file_path)
...
filename <- paste0("/home2/bxster25/traceplots-sscu/circ/traceplot_13_", timestamp, ".pdf")
pdf(filename, width = 8, height = 6)
print(traceplot(fit, pars = pars))
dev.off()

save(fit, file = "/beegfs/car/bxster25/circ-oc-sscu/saveimage/_13.Rdata")
