#!/bin/tcsh
#SBATCH --job-name=stan1_ncirc_core32
#SBATCH --mail-type=ALL
#SBATCH --nodes=2
#SBATCH --ntasks-per-node=4
#SBATCH --mem=64G
#SBATCH --time=7-00:00:00
#SBATCH --output=stan1_ncirc_core32.out
#SBATCH --error=stan1_ncirc_core32.err
...
Rscript /beegfs/car/bxster25/plxparam_stan_x/plxparam_stan1.R
