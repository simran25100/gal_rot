...
# - - - - -  - - - - -  - - - - -  - - - - -  - - - - -  - - - - -  - - - - - 
file_path <- "/beegfs/car/bxster25/oc-sscu/gaia18_subset/subset_17.csv" 
df <- fread(file_path)
...
filename <- paste0("/home2/bxster25/traceplots-sscu/ncirc/traceplot_17_", timestamp, ".pdf")
pdf(filename, width = 8, height = 6)
print(traceplot(fit, pars = pars))
dev.off()

save(fit, file = "/beegfs/car/bxster25/oc-sscu/saveimage/_17.Rdata")
